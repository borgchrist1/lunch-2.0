...
new Vue({
    ...
    mounted: function mounted() {
        ...
        axios.get(api).then(function (response) {
            return _this.resturants = response.data;
    ...
    created: function created() {
        ...
        var btnRandomLunch = document.querySelector('.random-lunch');
        var reloadAlts = document.querySelector('.reloadAlts-lunch');
        ...
        function getLunch(alt, addToDom) {
            var lenght = alt.length;
            var result = Math.floor(Math.random() * (lenght - 0)) + 0;
        ...
        btnRandomLunch.addEventListener('click', function (event) {
            getLunch(alt, result);
        });

        // starts getLunch function
        reloadAlts.addEventListener('click', function (event) {
            getLunch(alt, result);
        });
    }
});
